...
// UI Class: Handle UI Tasks like - display books, add books to list, remove books from list, show alert
class UI {
    // static - ao we don't have to instantiate UI everytime we wanna use displayBooks()
    static displayBooks() {
